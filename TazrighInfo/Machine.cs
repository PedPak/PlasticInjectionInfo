...
namespace TazrighInfo
{
    class Machine
    {
        ...
        {
            //bool result=true;
            string sql = "Update Machine set Name='{0}' where ID={1}";
        ...
        {
            //bool result = true;
            string sql = "insert into Machine (Name) values ( '{0}' ) ";
        ...
        {
            string sql = "delete from Machine where ID={0} ";
        ...
        public bool GetOne()
        {
            ...
            string sql = "select * from Machine where ID={0}";
            sql = string.Format(sql, this.Id);
            DataTable dt = null;
        ...
        {
            string sql = "select ID , Name from Machine ORDER BY Name ";
            DataTable dt = null;
